  ...
  return <div className="flex w-full h-full justify-center items-center align-middle">
    <div className="max-w-80 flex flex-col gap-6 items-center">
      ...
      <div className="text-center flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">Select an image from the left to start editing</p>
      </div>
      <Separator />
      <Alert className="border-none">
        ...
        <AlertDescription>
          Use your <ShortcutKeys settingsKey="nextImage" /> and <ShortcutKeys settingsKey="previousImage" /> keys to navigate between images.
        </AlertDescription>
      </Alert>
    </div>
  </div>
